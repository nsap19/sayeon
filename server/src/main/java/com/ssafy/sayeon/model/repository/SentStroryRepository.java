...
public interface SentStroryRepository extends JpaRepository<SentStory, String> {
	...
	@Query(nativeQuery=true, value="select s.storyId, senderId, receiverId, dateSent, dateReceived, image, imageType, sk.keyword from sentstory s\r\n" + 
			"inner join selectedkeyword sk\r\n" + 
			"on s.storyId = sk.storyId\r\n" +
			"join receivedstory r\r\n" + 
			"on s.storyId=r.storyId\r\n" + 
			"where receiverId=:myId\r\n" + 
			"and senderId = :friendId\r\n" + 
			"union\r\n" + 
			"select s.storyId, senderId, receiverId, dateSent, dateReceived, image, imageType, sk.keyword from receivedstory r\r\n" + 
			"inner join selectedkeyword sk\r\n" + 
			"on r.storyId = sk.storyId\r\n" +
			"join sentstory s\r\n" + 
			"on s.storyId=r.storyId\r\n" + 
			"where senderId=:myId\r\n" + 
