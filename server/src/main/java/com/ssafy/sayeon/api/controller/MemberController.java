...
public class MemberController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody UserLoginReq authenticationRequest) throws Exception {
	...
	public ResponseEntity<? extends BaseResponseBody> confirmEmail(@RequestBody String email) {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "사용 가능한 닉네임"), @ApiResponse(code = 409, message = "중복된 닉네임"),
			@ApiResponse(code = 500, message = "서버 오류") })
	public ResponseEntity<? extends BaseResponseBody> confirmNickname(@RequestBody String nickname) {
